...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/gayly/assets/plugins/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/vendor/gayly/assets/plugins/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
