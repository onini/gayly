	...
	<div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
		<div class="user-info-wrapper sm">
			<div class="profile-wrapper sm">
				<img src="{{ gayly_asset('vendor/gayly/assets/img/profiles/avatar.jpg" alt="" data-src="{{ gayly_asset('vendor/gayly/assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar2x.jpg" width="69" height="69" />
